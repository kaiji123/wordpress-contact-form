...
class Custom_Contact_Widget extends WP_Widget {
      public function __construct() {
          parent::__construct(
              ...
              __('Custom Contact Form Widget', 'custom-contact-form-widget'),
              array('description' => __('A custom contact form widget', 'custom-contact-form-widget'))
          );
      ...
      public function form($instance) {
          // Widget form fields
          $title = !empty($instance['title']) ? $instance['title'] : __('Contact Us', 'custom-contact-form-widget');
          ?>
          <p>
              <label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Title:', 'custom-contact-form-widget'); ?></label>
...
function enqueue_block_frontend_assets() {
      ...
      wp_enqueue_script(
            'custom-contact-form-widget-block-frontend', // Handle
            MY_PLUGIN_URL . 'includes/custom-frontend.js', // Path to the JavaScript file
            array('jquery'), // Dependencies
            null, // Version (can be null)
            true // Enqueue in footer
        );
}
function enqueue_block_editor_assets() {
      wp_enqueue_script(
          'custom-contact-form-widget-block', MY_PLUGIN_URL . 'includes/custom-contact-form-widget-block.js',
...
{     // this is the function for add_shortcode
      include MY_PLUGIN_PATH . '/includes/templates/contact-form.php';
}
